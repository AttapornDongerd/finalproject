            ...
            function initDataTables(tableData) {
                $('#logs').DataTable({
                    ...
                    columns: [{title: "ลำดับ", className: "align-middle"},
                        {title: "รหัสแก้ชุด", className: "align-middle"},
                        {title: "รายละเอียดการแก้ชุด", className: "align-middle"},
                        {title: "วันที่", className: "align-middle"},
