            ...
            $.ajax({
                ...
                data.response.forEach(function(item, index) {
                    tableData.push([
                        ...
                        <a href="form-edit.php?id=${item.cus_id}" type="button" class="btn btn-warning text-white">
                            <i class="far fa-edit"></i> แก้ไข
                        </a>
                        <button type="button" class="btn btn-danger" id="delete" data-id="${item.cus_id}" data-index="${index}">
            ...
            function initDataTables(tableData) {
                $('#logs').DataTable({
                    ...
                    columns: [{title: "ลำดับ", className: "align-middle"},
                        {title: "รหัสลูกค้า", className: "align-middle"},
